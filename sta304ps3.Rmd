...
The dataset we used was from the 2017 GSS survey conducted by the Canadian Government. According to the Government's website, the objectives of the survey were to gather data on social trends and to provide information on the most important social issues. 
...
For our model, we used the variables: number of children, sex, respondent income, whether the respondent is married not, rent (which was changed to become a binary 1 or 0 for if a person rents a home) and lastly we made a new variable which is binary and gives a 1 if the respondent has only completed high school or equivalent and 0 otherwise.
...
Where e is the exponential function and sum is the sum of our model equation.
...
Lastly, when we look at the variables that cover renting vs owning and a person's marraige status, we find that people that rent houses have lower chances of only completed high school and people that are married are much more likely to have completed a higher education. The renting coefficient is suprising because you would expect that people who own homes would have completed high school. There are a few probable explanations; more respondents are renting their homes meaning that it skews the data or younger people that responded may have not known what to select and said they owned the home they live at.
