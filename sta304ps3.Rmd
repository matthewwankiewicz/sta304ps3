...
$$log \left( \frac{\hat{p}}{1-\hat{p}} \right) = -2.66 - .18*x_{children}
+ .48*x_{male} +-.1*x_{income > 125000} + 1.49*x_{income_{25000-49999}} + \\ .76*x_{income_{50000 - 74999}} + .24*x_{income_{75000-99999}} + 2.2*x_{income_{< 25000}} - .47*x_{marraige} + .58*x_{canada}$$
